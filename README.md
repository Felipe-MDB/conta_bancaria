...
1\. Clone o repositório \[Aulas Java](https://github.com/Felipe-MDB/conta\_bancaria) dentro da pasta do \*Workspace\* do Eclipse/STS



```bash

git clone https://github.com/Felipe-MDB/conta\_bancaria.git
...
Desenvolvido por \[\*\*Felipe\*\*](https://github.com/Felipe-MDB)
