...
public class Menu {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (opcao == 0) { 
                System.out.println(Cores.TEXT_WHITE_BOLD + "\nBranco do Brazil com Z - O seu futuro começa aqui!");
                sobre(); // Agora ele vai encontrar o método corretamente
                leia.close();
                System.exit(0);
            }
    ...
    public static void sobre() {
        ...
        System.out.println("Felipe Marques de Brito - femarques.brito@outlook.com");
        System.out.println("github.com/Felipe-MDB");
        System.out.println("*********************************************************");
    }   
    ...
    private static void criarContasTeste() {
    	...
    	contaController.cadastrar(
    			new ContaCorrente(contaController.gerarNumero(), 456, 1, "Maria da Silva", 2000.00f, 200.00f));
    	contaController.cadastrar(
